...
public:
    ...
    // @return Mat4 - a 4x4 matrix representing a transformation from real-world points to camera-relative points
    Mat4 GetViewMatrix() const;

    // This is the perspective effect
    // @return Mat4 - a 4x4 matrix representing a transformation from camera-relative points to camera-perspective points
    // Scales points based on distance
    ...
    // Allow user to drag by performing an operation on the camera's position based on the mouse velocity
    // @param const Point2D &mouse_velocty - the x and y velocities of the mouse in a given frame
