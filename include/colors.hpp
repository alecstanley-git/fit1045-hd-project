...
enum Color : std::uint64_t
{
    ...
    // AI use disclosure: Initially I was using the above seven basic colours. When I got later in development I wanted to improve the looks, and prompted AI to list some nice colour hex codes and names. I did not give it any data about my project other than a brief overview.
